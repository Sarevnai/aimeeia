    ...
    if (isHandoffIntent && qualScore >= 65 && hasShownProperties) {
      ...
      return jsonResponse({
        ...
        qualification: {
          ...
          detected_income_monthly: mergedQual.detected_income_monthly || null,
          detected_has_pets: typeof mergedQual.detected_has_pets === 'boolean' ? mergedQual.detected_has_pets : null,
          detected_pet_type: mergedQual.detected_pet_type || null,
          detected_move_in_date: mergedQual.detected_move_in_date || null,
